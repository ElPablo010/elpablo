                ...
                Section::make('Bedrijfsgegevens')
                    ...
                    ->schema([
                        ...
                        TextInput::make('business_description')
                            ...
                            ->helperText('bv. "een Urban Latin DJ uit Antwerpen". Geeft AI-functies context.'),
                    ])
                    ->columns(2),
                ...
                Section::make('AI')
                    ...
                    ->schema([
                        ...
                        Textarea::make('ai_facts')
                            ...
                            ->rows(6)
                            ->columnSpanFull()
                            ->helperText('Werkgebied, soorten events, tarieven, USP\'s… AI-functies gebruiken ENKEL deze feiten in gegenereerde content — zo verzinnen ze niets.'),
                    ]),
            ])
            ->statePath('data');
    }
