...
return [
    ...
    */
    ...
    'temporary_file_upload' => [
        ...
        // DJ-sets zijn grote mp3's (een uur op 192kbps is al ~85MB). Livewire's
        // default van 12MB is daar veel te krap. 128MB in kilobytes; blijft
        // ruim boven de ->maxSize(102400) (100MB) op het audioveld, zodat
        // Filament degene is die de nette foutmelding geeft.
        // LET OP: PHP's upload_max_filesize + post_max_size moeten minstens even
        // hoog staan, anders sneuvelt de upload al vóór Livewire (zie CLAUDE.md).
