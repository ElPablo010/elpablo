<div>
    ...
    @if ($sent)
        <div class="flex items-start gap-3 rounded-xl border border-green-500/30 bg-green-500/10 p-6 text-green-300" role="status">
            ...
            <div>
                <p class="font-semibold text-green-200">Bedankt voor je bericht!</p>
    ...
    @else
        <form wire:submit="submit" class="space-y-5">
            ...
            <div>
                <label for="cf-name" class="mb-1.5 block text-sm font-medium text-gray-200">Naam</label>
            ...
            <div class="grid gap-5 sm:grid-cols-2">
                <div>
                    <label for="cf-email" class="mb-1.5 block text-sm font-medium text-gray-200">E-mail</label>
                ...
                <div>
                    <label for="cf-phone" class="mb-1.5 block text-sm font-medium text-gray-200">
                        Telefoon <span class="text-gray-500">(optioneel)</span>
                    </label>
            ...
            <div>
                <label for="cf-message" class="mb-1.5 block text-sm font-medium text-gray-200">Bericht</label>
