...
@if ($isAdmin)
    ...
    <div class="pointer-events-none fixed inset-x-0 top-24 z-40 px-4">
        <div class="mx-auto flex max-w-7xl justify-end">
            <a
                ...
                class="pointer-events-auto inline-flex h-12 w-12 items-center justify-center rounded-full border border-white/10 bg-ink-900/80 text-white shadow-lg shadow-black/30 backdrop-blur-md transition-colors duration-200 hover:bg-primary-600 hover:text-white"
            >
